...
import tokenization
from modeling_multitask_MoE_merge_noShared_aug import BertConfig, BertForSequenceClassification
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            if avg_f1 > best_f1:
                torch.save({
                    ...
                    'classifier1_merge': model.classifier1_merge.state_dict(),
                    'classifier2_merge': model.classifier2_merge.state_dict(),
                    'classifier3_merge': model.classifier3_merge.state_dict(),
                    'classifier4_merge': model.classifier4_merge.state_dict(),
