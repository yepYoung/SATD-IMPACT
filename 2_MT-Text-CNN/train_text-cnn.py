...
from roberta_multitask import RobertaConfig
from modeling_multitask import Text_CNNForSequenceClassification
...
class AllProcessor(DataProcessor):
    ...
    def get_labels(self):
        return [["NON-SATD", "Code", "Test", "Build", "Architecture", "Documentation", "Defect", "Design", "Requirement"],
                ["NON-SATD", "Code", "Test", "Build", "Architecture", "Documentation", "Defect", "Design", 'Requirement'],
                ["NON-SATD", "Code", "Test", "Build", "Architecture", "Documentation", "Defect", "Design", 'Requirement'],
                ["NON-SATD", "Code", "Test", "Build", "Architecture", "Documentation", "Defect", "Design", 'Requirement']]
...
def main():
    ...
    parser.add_argument("--data_dir",
                        default="/home/lqy/WorkSpace/MT-BERT/tarin_dev_dataset",
                        type=str,
                        required=False,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--bert_config_file",
                        default="/home/lqy/WorkSpace/MT-BERT/RoBERTa/config.json",
                        type=str,
                        required=False,
    ...
    parser.add_argument("--vocab_file",
                        default="/home/lqy/WorkSpace/MT-BERT/RoBERTa/vocab.json",
                        type=str,
                        required=False,
                        help="The vocabulary file that the BERT model was trained on.")
    parser.add_argument("--output_dir", 
                        default="/home/lqy/WorkSpace/MT-BERT/CNNModel_results_dir",
                        type=str,
                        required=False,
    ...
    model = Text_CNNForSequenceClassification(bert_config, len(label_list))########################################################################
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            eval_recall_issue = recall_score(origin_label_list_issue, predict_label_list_issue, average='macro')
            eval_precision_issue = precision_score(origin_label_list_issue, predict_label_list_issue, average='macro')
            ...
            eval_recall_pr = recall_score(origin_label_list_pr, predict_label_list_pr, average='macro')
            eval_precision_pr = precision_score(origin_label_list_pr, predict_label_list_pr, average='macro')
            ...
            eval_recall_commit = recall_score(origin_label_list_commit, predict_label_list_commit, average='macro')
            eval_precision_commit = precision_score(origin_label_list_commit, predict_label_list_commit , average='macro')
            ...
            eval_recall_code_comments = recall_score(origin_label_list_code_comments, predict_label_list_code_comments,average='macro')
            eval_precision_code_comments = precision_score(origin_label_list_code_comments,
                                                           predict_label_list_code_comments,average='macro')
            ...
            if avg_f1 > best_f1:
                torch.save({
                    ...
                    'list_conv': model.list_conv.state_dict(),
